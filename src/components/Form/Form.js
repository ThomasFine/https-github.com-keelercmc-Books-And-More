...
const form = (props) => {
    return(  
        <form>
            ...
            <input type="number" placeholder="Length" min="0" onChange={props.changeHandler(fields.length)}></input>
            <input type="number" placeholder="Rating" min="0" max="10" onChange={props.changeHandler(fields.rating)}></input>
